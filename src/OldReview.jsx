      ...
      <div className="w-full py-[104px] lg:py-36 xl:py-40 flex justify-center items-center bg-white">
        <div className=" w-small lg:w-[816px] xl:w-extraLarge">
          ...
          <p className="text-center mt-4 lg:mt-5">
            ...
            overall rating of how good your resume is for the job you are
            looking to get, the other three focus on specific areas of your
            resume that can be improved. Within each of the three sections,
            you'll find six sub headings that will outline where you can
            implement changes to better your resume.
          </p>
          <p></p>
        </div>
      </div>
   ...
   */}
      ...
      <div className="w-small lg:w-[816px] xl:w-extraLarge py-[104px]">
        ...
        <p className="mt-7 font-light">
          Thank you for using our resume analysis tool. Our goal is to empower
          you with insights that can help you refine your resume and stand out
          in your job search. We hope that the feedback provided has been
          valuable in highlighting areas of strength and opportunities for
          improvement. Remember, a well-crafted resume is just the first step in
          your professional journey. Keep learning, keep improving, and keep
